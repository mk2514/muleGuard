...
export const FRAUD_SCENARIOS = {
  'Bank Fraud': {
    name: 'Bank Fraud',
    description: 'High volume & burst velocity transactions with layering behavior.',
  ...
  'SIM Swap & Takeover': {
    ...
    description: 'Immediate SIM swap followed by authentication bypass, call bursts, and rapid fund drains.',
    weights: { behavior: 30, network: 25, rules: 45 },
  ...
  'Social Media Extortion': {
    name: 'Social Media Extortion',
    description: 'Repeated blocks/unblocks on Instagram, coercive vishing calls, and rapid UPI ransom demands.',
    weights: { behavior: 30, network: 25, rules: 45 },
  ...
  'Mule Ring & Hawala': {
    name: 'Mule Ring & Hawala',
    description: 'Shared bank accounts, multiplexed devices, fan-out smurfing, and circular routing loops.',
    weights: { behavior: 25, network: 55, rules: 20 },
  ...
  'Crypto Laundering': {
    ...
    description: 'Rapid fiat off-ramping into OTC USDT and peer-to-peer cold wallet transfers.',
    weights: { behavior: 35, network: 45, rules: 20 },
    contextualAdjustment: 5,
    avgTxn: '₹45,200',
    maxTxn: '₹1,50,000',
    todayDeviation: '5.2σ',
  ...
  'Cyber Extortion': {
    ...
    description: 'Coordinated phishing campaigns with sudden mule account fan-out and pressure calls.',
    weights: { behavior: 35, network: 30, rules: 35 },
    contextualAdjustment: 4,
    avgTxn: '₹8,900',
    maxTxn: '₹40,000',
    todayDeviation: '3.9σ',
